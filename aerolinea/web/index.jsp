    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                ...
                <br>
                <h6 class="text-center" style="color: white;">  <strong>Bienvenido</strong></h6>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="javascript:void(0)"><i style="color: white;" class="fa fa-align-justify"></i><span>Servicios</span></a>
                                <ul class="collapse">

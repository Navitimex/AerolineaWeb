                        ...
                        <nav>
                            <ul class="metismenu" id="menu">
                                ...
                                <li>
                                    ...
                                    <ul class="collapse">
                                        <li><a href="/aerolinea/Vistas/Administrador/InsertarAvion.jsp" ><i class="fa fa-plane"></i> Registrar Aviones</a></li>
                                        <li><a href="/aerolinea/Vistas/Administrador/InsertarDestino.jsp" ><i class="fa fa-plane"></i> Registrar Destinos</a></li>
                                        <li><a href=""><i class="fa fa-plane"></i> Registrar Vuelos</a></li>

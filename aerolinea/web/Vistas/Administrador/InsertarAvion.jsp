                ...
                <div class="login-box ptb--100">
                    ...
                    <form>
                        <div class="login-form-head">
                            <h4>Registro de Aviones</h4>

                        </div>
                        <div class="login-form-body">

                            <div class="form-gp">
                                <label for="input_anio">Año</label>
                                <input type="number" id="input_anio" required>
                                <i class="ti-anio"></i>
                            </div>

                            <div class="form-gp">
                                <label for="input_modelo">Modelo</label>
                                <input type="text" id="input_modelo" required>
                                <i class="ti-modelo"></i>
                            </div>
                            <div class="form-gp">
                                <label for="input_marca">Marca</label>
                                <input type="text" id="input_marca" required>
                                <i class="ti-marca"></i>
                            </div>

                            <div class="form-gp">
                                <label for="input_canasientos">Cantidad De Asientos</label>
                                <input type="number" id="input_canasientos" required>
                                <i class="ti-canasientos"></i>
                            </div>


                            <div class="submit-btn-area">
                                <button  type="button" onclick="insertarAvion()" >Enviar <i class="ti-arrow-right"></i></button>
